    ...
    <div class="content-width px-7">
      ...
      <p class="pt-3 pb-5">
        <ul class="list-disc">
          ...
          <li>In addition to Arabic, Omar has studied traditional Islamic sciences like aqidah ('Ashari), fiqh (Shafi'i, Hanafi, and Maliki), 'usul al-fiqh, hadith methodology, and tajwid with Shaykh Hamza Karamali, Shaykh Mujahid Abdul-Karim, Shaykh Abdul-Karim Yahya, Mawlana Syed Javed Ali Shah,  Shaykh Ashraf Muneeb, Shaykh Faraz Rabbani, Shaykh Isa Husayn, Shaykh Saifullah Abu M., Shaykh Salah al-Kurdi, Shaykh Ali Hani, and others.</li>
        </ul>
      </p>
