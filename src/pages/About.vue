    ...
    <div class="content-width px-7">
      ...
      <p class="pt-3 pb-5">
        <ul class="list-disc">
          ...
          <li>Afterwards, he studied with Dr. Hamid Ouali at the University of Wisconsin-Milwaukee using parts of al-Kitab fi Ta'allum al-'Arabiyyah and doing research in comparative Arabic dialects as part of a Bachelor of Arts in Linguistics degree. During that time, he studied additional subjects in Linguistics like Phonetics, Phonology, Syntax, teaching English grammar, Language Typology & Universals with Dr. Edith Moravcsik and other professors.</li>
          <li>He continued his Arabic studies at online institutions like Sunnipath/Qibla with Shaykh Sulayman Van Ael and Shaykh Farid Dingle, at Studio Arabiyyah with Ustadh Muhammad Metweley, and at Sibawayh Center with with Ustadh Sayed Fathy covering texts in balagha like al-Tuhfat al-Ikhwan fi 'Ilm al-Bayan, al-Balagha al-Wadiah, and Duroos al-Balagha as well as other Arabic studies like Egyptian Arabic and Media Arabic.</li>
          ...
          <li>He studied in private Skype lessons for 2.5 years with Mawlana Syed Javed Ali Shah covering Hidayat al-Nahw, Abwab al-Sarf, 'Ilm al-Seegah, I'raab of 1/2 juz from Sura al-Ma'idah, a portion of Sharh al-'Awamil al-Mi'ah by al-Jurjani, and texts in other Islamic sciences.</li>
          <li>He has also studied other Islamic sciences with Shaykh Hamza Karamali, Shaykh Abdul-Karim Yahya, Mawlana Syed Javed Ali Shah, Shaykh Mujahid Abdul-Karim, Shaykh Salah al-Kurdi, Shaykh Ali Hani, Shaykh Isa Husayn, and Shaykh Saifullah Abu M. in areas like aqidah ('Ashari), fiqh (Shafi'i, Hanafi, and Maliki), 'usul al-fiqh, hadith methodology, and tajwid.</li>
        </ul>
      </p>
